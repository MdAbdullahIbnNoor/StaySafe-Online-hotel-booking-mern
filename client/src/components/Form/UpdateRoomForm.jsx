...
const UpdateRoomForm = ({ roomData, setRoomData, dates, handleDates, imagePreview, handleImage, imageText, handleSubmit, loading }) => {
    ...
    return (
        <div className='w-full min-h-[calc(100vh-40px)] flex flex-col justify-center items-center text-gray-800 rounded-xl bg-gray-50'>
            <form onSubmit={handleSubmit}>
                ...
                >
                    {loading ? <FaSpinner className='animate-spin w-14 mx-auto' /> : 'Update'}
                </button>
            </form>
        </div>
    )
